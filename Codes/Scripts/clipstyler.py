# -*- coding: utf-8 -*-
"""Updated_CLIPstyler.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1D2FN-8jH1fQv1oivB7YDx1VVtayw1cYZ
"""
...
file_path = '/content/drive/MyDrive/LUT Thesis/wikiauthors.txt'
with open(file_path, 'r') as file:
    wikiauthors_list = [line.strip() for line in file.readlines()]
print(wikiauthors_list)

"""# **ClipStyler**"""

for text in wikiauthors_list:
  source = "a Photo"
  crop_size = 128 #@param {"type": "integer"}
  image_dir = "/content/drive/MyDrive/LUT Thesis/content_example/14.jpg" #@param {type: "string"}
  ...
  for epoch in range(0, steps+1):
      ...
      if epoch %20 ==0:
          ...
          output_folder = '/content/drive/MyDrive/LUT Thesis/First_Experiment_outputs_CLIPstyler'

          os.makedirs(output_folder, exist_ok=True)
          output_filename = os.path.join(output_folder, f'{text}.jpg')
